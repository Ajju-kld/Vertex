...
class RegisterBloc extends Bloc<RegisterEvent, RegisterState> {
  ...
  void _onSubmitted(
    ...
    print('password match: ${_passwordsMatch()}');
    ...
    try {
      ...
      if (e is AuthException) {
        ...
        print(e.message);
        emit(state.copyWith(
            status: FormzSubmissionStatus.failure, error: e.message));
      } else {
        emit(state.copyWith(
  ...
  FutureOr<void> _onProfileImageChanged(
      ProfileImageChanged event, Emitter<RegisterState> emit) {
    final profileImage = ProfileImage.dirty(event.profileImage);
    emit(state.copyWith(
  ...
  FutureOr<void> _onNextButtonPressed(
      NextButtonPressed event, Emitter<RegisterState> emit) {
    emit(state.copyWith(

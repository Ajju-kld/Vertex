...
import 'package:vertex/repository/authentication_repository.dart';
import 'package:vertex/repository/user_repository.dart';
...
class AuthenticationBloc extends Bloc<AuthenticationEvent, AuthenticationState> {
  ...
  super(const AuthenticationState.unknown()) {
    on<_AuthenticationStatusChanged>(_onAuthenicationStatusChanged);
  ...
  Future<void> _onAuthenicationStatusChanged(
